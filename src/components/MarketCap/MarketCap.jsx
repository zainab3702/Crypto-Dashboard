...
const MarketCap = () => {
  ...
  return (
    <div className="w-full h-screen lg:h-[728px] text-white shadow-sm transition ease-in-out hover:ring-4 rounded-md ring-blue-400 ring-offset-slate-50 overflow-y-scroll bg-cyan-600 bg-opacity-10 backdrop-blur-md">
