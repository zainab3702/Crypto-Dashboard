...
const ChatTypeSelector = () => {
  ...
  return (
    <div className="max-sm:w-10/12 w-4/12 max-lg:w-5/12 max-sm:h-6 h-10 flex rounded-md border hover:border-blue-500">
      <div className="w-full h-full items-center relative flex rounded-md bg-cyan-900 text-white shadow-sm">
        ...
        {isOpen && (
          <div className="min-width-[200px] absolute max-sm:top-2 top-7 right-0 z-10 mt-4 origin-top-right rounded-md border border-gray-100 bg-cyan-900 shadow-lg">
            <div>
