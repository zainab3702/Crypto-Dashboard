...
const CoinExchange = () => {
  ...
  return (
    <div className="lg:w-1/2 h-64 max-sm:px-3 px-8 py-3 bg-cyan-600 bg-opacity-10 backdrop-blur-md shadow-sm transition ease-in-out hover:ring-4 ring-blue-400 ring-offset-slate-50 rounded-md">
      ...
      <div className="flex flex-col mt-4 gap-5">
        <div className="flex items-start justify-between">
          <div className="w-1/2 flex items-center max-sm:gap-1 gap-3">
            ...
            <div className="w-10/12 max-sm:h-10 h-12 flex rounded-md border hover:text-blue-700 hover:border-blue-500">
              <div className="w-full h-full items-center relative flex rounded-md bg-cyan-900 text-white shadow-sm">
                <div
                ...
                {isSellOpen && (
                  <div className="max-sm:h-[95px] max-sm:w-[90px] w-[145px] h-[140px] absolute max-sm:top-6 top-9 right-0 z-10 mt-4 origin-top-right rounded-md border border-gray-100 bg-cyan-900 shadow-lg overflow-y-scroll">
                    <div>
        ...
        <div className="flex items-center justify-center">
          <button
            onClick={HandleClick}
            className="text-white font-medium max-sm:px-4 max-sm:py-2 px-6 py-3 rounded-lg max-sm:text-sm bg-[#881337] hover:bg-[#164e63] cursor-pointer"
          >
            Exchange
          </button>
        </div>
